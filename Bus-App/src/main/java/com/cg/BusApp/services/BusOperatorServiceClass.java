...
import com.cg.BusApp.exceptions.BusAlreadyExistsException;
import com.cg.BusApp.exceptions.BusOperatorAlreadyExistsException;
...
@Service
public class BusOperatorServiceClass implements IBusOperatorService {
	...
	//Dependency injections of required repositories
		...
		public void addBus(Bus b) {
			...
			if(bus == null) {
				...
				throw new BusAlreadyExistsException("Bus with following number already exists: " + b.getBusNumber());
			}
		}
